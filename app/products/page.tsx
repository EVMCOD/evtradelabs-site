...
const PRODUCTS = [
  ...
  },
  {
    ...
    hasPage: true,
    name: "EV Métricas",
    tagline: "Analítica profesional de tu cuenta MT5",
    description:
      "Conecta tu cuenta MT5 y visualiza tus métricas en tiempo real: equity curve, P&L mensual, heatmap de sesiones, desglose por símbolo y estadísticas avanzadas. Enlace verificado compartible.",
    priceMonthly: 9.99,
    priceLifetime: null,
    currency: "EUR",
    tier: "Studio License",
