...
export async function sendLicenseEmail({ to, customerName, productName, licenseKey, orderId }: LicenseEmail) {
...
export async function POST(request: Request) {
  try {
    ...
    if (type === "license") {
      const result = await sendLicenseEmail(payload as LicenseEmail);
