        ...
        <div className="flex items-center justify-between h-[68px]">
          ...
          <div className="hidden lg:flex items-center gap-3" ref={dropdownRef}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              >
                <span className="w-8 h-8 rounded-full bg-gradient-to-br from-[#667eea]/40 to-[#764ba2]/40 border border-white/10 flex items-center justify-center text-sm">
                  👤
                </span>
                <span>Mi Cuenta</span>
              ...
              {accountMenuOpen && (
                ...
                >
                  ...
                  <div className="p-2 border-t border-white/[0.06]">
                    <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-red-400/80 hover:text-red-400 hover:bg-red-500/10 transition-colors">
                      <span>🚪</span>
        ...
        <div className="lg:hidden border-t border-white/[0.06] bg-[rgba(10,10,15,0.98)] backdrop-blur-xl">
          <div className="max-w-[1200px] mx-auto px-6 py-4 flex flex-col gap-1">
            ...
            <Link
              href="/products"
              onClick={() => setOpen(false)}
              className="mt-4 text-center text-[0.9rem] font-semibold px-6 py-3 rounded-xl bg-[#667eea] text-white"
            >
              Ver productos
            </Link>
          </div>
